...
//direct reference to the package we installed: npm install ejs --save
app.set('view engine', 'ejs');

//sets which folder is for 'views' <- our folder /views , where you place htmls
app.set('views', 'views');

//sets location for layouts to /views/layouts/main-layout.ejs
